...
//
// \todo MERGE CONFLICT: ab7987d vs. 6576e3c
// I discarded hwrconvert() in the latter commit because more of the code depends
// on GIF_rgbconvert(). I don't know how this works. Sorry!
#ifdef HWRENDER
